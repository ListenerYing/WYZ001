...
(5,'3.87','我深深迷恋古人所说的读万卷书，行万里路。因此我一爱看书，二爱旅行。',100),
...
(100,'讲师',223749,'人品正直，热爱学习','于2008年取得英国计算机科学博士学位，发表多篇期刊和会议文章。现指导多名研究生从事计算机科学、教育技术学和神经科学等方面的教学和研究工作。'),
(101,'副教授',996,'负责任，擅长计算机知识','已入选浙江省高校中青年学科带头人、浙江省151人才工程和浙江工业大学青年英才支持计划。'),
(102,'讲师',2,'有进取心，乐于助人，有管理能力','致力于特殊教育信息化和职业教育信息化，重点开展职业院校智慧教育和孤独症儿童早期干预研究。'),
(103,'教授',7,'在计算机领域有所成就，可以潜下心来敲代码','在国内权威期刊发表学术论文，研究成果获得浙江省科学技术进步奖和浙江省高校科研成果奖。'),
...
/* Event structure for event `student_assign` */

/*!50106 DROP EVENT IF EXISTS `student_assign`*/;

DELIMITER $$

/*!50106 CREATE DEFINER=`root`@`localhost` EVENT `student_assign` ON SCHEDULE AT '2022-06-23 08:02:00' ON COMPLETION PRESERVE DISABLE DO BEGIN
